...
class AxisTest {
    ...
    void testLookupByNumber() {
        ...
        assertNull(Axis.lookup(999)); // Testing with an invalid number
    }
    ...
    void testLookupByName() {
        ...
        assertEquals(Axis.INVALID_AXIS, Axis.lookup("")); // Testing with an empty string
        assertEquals(Axis.INVALID_AXIS, Axis.lookup(null)); // Testing with null
    }
}
```