...
class SortTest {
    ...
    void testSortThrowsNoSuchFieldException() {
        ...
        assertEquals("No such field 'nonExistingField exists in class org.example.run1.SortTest$Point!", exception.getMessage());
    }
    ...
    void testSortThrowsNoSuchMethodException() {
        ...
        assertEquals("No method 'getY()' exists in class org.example.run1.SortTest$Point!", exception.getMessage());
    }
}
```