...
//    }
     ...
     * Problem: This is an ordinary case, but the LLM incorrectly assumed otherwise
     */
    @Test
    void testUnsupportedEncodingExceptionEncode__fixed() {
        String input = "Hello, World!";
        try {
            assertEquals("SGVsbG8sIFdvcmxkIQ==", StringEncoder64.encodeStringUTF8(input));
        } catch (Exception e) {
            fail("Exception should not be thrown");
        }
    }
...
//    }
     ...
     */
    @Test
    void testUnsupportedEncodingExceptionDecode__fixed() {
        String input = "SGVsbG8sIFdvcmxkIQ==";
        try {
            assertEquals("Hello, World!", StringEncoder64.decodeStringUTF8(input));
        } catch (Exception e) {
            fail("Exception should not be thrown");
        }
    }
