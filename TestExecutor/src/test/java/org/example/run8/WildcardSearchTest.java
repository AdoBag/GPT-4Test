...
//    }
     ...
     * Problem: The given string did not match the expression
     */
    @Test
    public void testWildcardInMiddle__fixed() {
        WildcardSearch search = new WildcardSearch("te*t");
        assertTrue(search.doesMatch("testingt"));
    }

    /**
     * The below test catches a bug
     */
//    @Test
...
//    }
    /**
     * Manual fix of the above test
     * Problem: The given string matched the expression
     */
    @Test
    public void testWildcardMismatch__fixed() {
        WildcardSearch search = new WildcardSearch("t*sk*");
        assertFalse(search.doesMatch("testing"));
    }
