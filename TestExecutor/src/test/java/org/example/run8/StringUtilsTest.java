...
//        assertEquals("control &#x000d;&#x000a;", StringUtils.escapeForXML("control \r\n"));
        ...
        assertEquals("control ILLEGAL-XML-CHAR:000d;ILLEGAL-XML-CHAR:000a;", StringUtils.escapeForXML("control \r\n"));

//        assertEquals("ILLEGAL-XML-CHAR:&#x0007;", StringUtils.escapeForXML("\u0007"));
        /** Incorrect output for the illegal char */
        assertEquals("ILLEGAL-XML-CHAR:0007;", StringUtils.escapeForXML("\u0007"));
    }
...
//        assertEquals("nothing to replace", StringUtils.substitute("nothing to replace", "", "test"));
        ...
        assertEquals("testnothing to replace", StringUtils.substitute("nothing to replace", "", "test"));
