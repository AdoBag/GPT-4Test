...
//        assertEquals(0xF0, byteVector.data[7]);
        ...
        assertEquals(-0x66, byteVector.data[4]);
        assertEquals(-0x44, byteVector.data[5]);
        assertEquals(-0x22, byteVector.data[6]);
        assertEquals(-0x10, byteVector.data[7]);
    }
