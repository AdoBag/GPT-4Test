...
//    }
     ...
     */
    @Test
    void testAltBase64ToByteArray__fixed() {
        String altBase64 = "!\"#$%&'(),-.:;<>";
        byte[] expectedBytes = {0, 16, -125, 16, 81, -121, 32, -110, -117, 48, -45, -113};
        assertArrayEquals(expectedBytes, Base64.altBase64ToByteArray(altBase64));
    }
...
//    }
    ...
    /**
     * Manual fix of the above test
     * Problem: The LLM converted incorrectly
     */
    @Test
    void testBase64ToByteArray__fixed() {
        String base64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
        byte[] expectedBytes = {
                0, 16, -125, 16, 81, -121, 32, -110, -117, 48, -45, -113, 65, 20,
                -109, 81, 85, -105, 97, -106, -101, 113, -41, -97, -126, 24, -93,
                -110, 89, -89, -94, -102, -85, -78, -37, -81, -61, 28, -77, -45,
                93, -73, -29, -98, -69, -13, -33, -65
        };
        assertArrayEquals(expectedBytes, Base64.base64ToByteArray(base64));
    }
...
//    }
    ...
    /**
     * Manual fix of the above test
     * Problem: The 'invalid' character was actually valid
     */
    @Test
    void testIllegalCharacterAltBase64__fixed() {
        String invalidChar = "!A#%";
        IllegalArgumentException thrown = assertThrows(
                IllegalArgumentException.class,
                () -> Base64.altBase64ToByteArray(invalidChar),
                "Expected to throw, but it didn't"
        );
        assertTrue(thrown.getMessage().contains("Illegal character A"));
    }
}
