...
//    public void testMaxCapacityExceededWithCapacity() {
    public void testMaxCapacityExceededWithCapacity__fixed() {
        queue = new Queue(1);
        assertFalse(queue.maxCapacityExceeded());
        queue.enqueue("Element1");
//        assertFalse(queue.maxCapacityExceeded());
    ...
    public void testToString() {
        queue.enqueue("Element1");
        String expectedString = "org.example.run3.Queue:[numItems=1, maxNumItems=1, maxCapacity=-1, getObjects()=[Element1]\r\n]";
