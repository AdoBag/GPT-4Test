...
public class AxisTest {
    ...
    public void testLookupInt() {
        ...
        assertNull(Axis.lookup(999));  // Test a completely invalid axis number
    }
    ...
    public void testLookupString() {
        ...
        assertEquals(Axis.INVALID_AXIS, Axis.lookup(""));  // Test an empty string
        assertEquals(Axis.INVALID_AXIS, Axis.lookup(null));  // Test a null value
    }
}
