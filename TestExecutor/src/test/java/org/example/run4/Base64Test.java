...
//    }
     ...
     */
    @Test
    void testAltBase64ToByteArray_validInput__fixed() {
        String base64String = ")@==";
        byte[] expectedBytes = new byte[]{33};
        byte[] actualBytes = Base64.altBase64ToByteArray(base64String);
        assertArrayEquals(expectedBytes, actualBytes);
...
//    }
     ...
     */
    @Test
    void testAltBase64ToByteArray_invalidChar__fixed() {
        String base64String = "I@@="; // 'I' not valid
        IllegalArgumentException thrown = assertThrows(
                IllegalArgumentException.class,
                () -> Base64.altBase64ToByteArray(base64String),
                "Expected altBase64ToByteArray() to throw, but it didn't"
        );
        assertEquals("Illegal character I", thrown.getMessage());
    }
...
//    }
     ...
     */
    @Test
    void testByteArrayToAltBase64_basic__fixed() {
