...
class WildcardSearchTest {
    ...
    /**
     * In the below test, both assertions find a different bug
     */
//    @Test
...
//    void testDoesMatch_wildcardInMiddle() {
    void testDoesMatch_wildcardInMiddle__fixed() {
...
//        assertFalse(search.doesMatch("heo"));
        ...
        assertTrue(search.doesMatch("heo"));
    }
